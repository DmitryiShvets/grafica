...
void Application::start()
{
	...
	ShaderProgram* default_prog = &resources->getProgram("default");
	Mesh* terrain = &resources->getMesh("terrain");
	Mesh* tree = &resources->getMesh("tree");
	Mesh* copter = &resources->getMesh("copter");
	Texture2D* terrain_texture = &resources->getTexture("grass");
	Texture2D* tree_texture = &resources->getTexture("tree");
	Texture2D* copter_texture = &resources->getTexture("copter");
	...
	glm::vec3 lightPosition(0, 14, 0);
	glm::vec3 lightDirection(0.f, -0.05f, -1.0f);
	...
	while (!glfwWindowShouldClose(window)) {
		...
		RenderObj(glm::vec3(-100, 0, -100), terrain, directionalLight, terrain_texture,
		1.5f, view, glm::vec3(0.0f, 0.0f, 1.0f), 0, 0, viewPos, 1);

		RenderObj(glm::vec3(30, 10, -120), tree, directionalLight, tree_texture,
			0.03f, view, glm::vec3(0.0f, 0.0f, 1.0f), 0, 0, viewPos, 1);

		RenderObj(glm::vec3(-20, 100, -100), copter, directionalLight, copter_texture,
			0.5f, view, glm::vec3(0.0f, 1.0f, 0.0f), 50, 0, viewPos, 1);
